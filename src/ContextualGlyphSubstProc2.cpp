...
void
ContextualGlyphSubstitutionProcessor2::beginStateTable(LEGlyphStorage &, LEErrorCode &)
{
    markGlyph = 0;
}

le_uint16
ContextualGlyphSubstitutionProcessor2::processStateEntry(LEGlyphStorage &glyphStorage, le_int32 &currGlyph, EntryTableIndex2 index, LEErrorCode &success)
{
    if (LE_FAILURE(success))
        return 0;
...
le_bool
ContextualGlyphSubstitutionProcessor2::lookup(le_uint32 offset, LEGlyphID gid, TTGlyphID &newGlyph, LEErrorCode &success)
{
